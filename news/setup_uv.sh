...
echo "🚀 Setting up News Knowledge Graph with uv"
echo "============================================"
...
echo "   • OPENAI_API_KEY     - For OpenAI embeddings and chat"
echo "   • ANTHROPIC_API_KEY  - For Anthropic chat (embeddings not supported)"
echo "   • Or use Ollama for local models (no API key required)"
echo ""
